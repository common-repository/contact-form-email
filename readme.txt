...
Tags: contact form, email submit form, message form, email subscription, attachment, contact, contact button, contact form plugin, contact me, contacts, contacts form plugin, feedback, feedback form, form, post feedback, request, send messages
...
Yes, there is a dedicated message box on the contact form.

= Can I make unlimited contact forms? =
You can make unlimited contact forms in the Contact Form Pro plugin.
...
= 1.4 =
* Change to use wp_mail() instead of mail()
* Removed css for width of contact form
